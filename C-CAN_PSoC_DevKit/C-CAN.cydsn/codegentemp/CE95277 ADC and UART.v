...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Time_Count, CY_INSTANCE_SHORT_NAME=Time_Count, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Time_Count, )
...
module top ;
	...
	wire [0:0] tmpOE__Vin_180_net;
	wire [0:0] tmpFB_0__Vin_180_net;
	wire [0:0] tmpIO_0__Vin_180_net;
	wire [0:0] tmpINTERRUPT_0__Vin_180_net;
	electrical [0:0] tmpSIOVREF__Vin_180_net;
	...
	cy_psoc3_pins_v1_10
		...
		Vin_180
		 (.oe(tmpOE__Vin_180_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vin_180_net[0:0]}),
		  .analog({Net_1120}),
		  .io({tmpIO_0__Vin_180_net[0:0]}),
		  .siovref(tmpSIOVREF__Vin_180_net),
		  .interrupt({tmpINTERRUPT_0__Vin_180_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vin_180_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Vin_90_net;
	wire [0:0] tmpFB_0__Vin_90_net;
	wire [0:0] tmpIO_0__Vin_90_net;
	wire [0:0] tmpINTERRUPT_0__Vin_90_net;
	electrical [0:0] tmpSIOVREF__Vin_90_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Vin_90
		 (.oe(tmpOE__Vin_90_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vin_90_net[0:0]}),
		  .analog({Net_7}),
		  .io({tmpIO_0__Vin_90_net[0:0]}),
		  .siovref(tmpSIOVREF__Vin_90_net),
		  .interrupt({tmpINTERRUPT_0__Vin_90_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vin_90_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Vin_Pot_net;
	wire [0:0] tmpFB_0__Vin_Pot_net;
	wire [0:0] tmpIO_0__Vin_Pot_net;
	wire [0:0] tmpINTERRUPT_0__Vin_Pot_net;
	electrical [0:0] tmpSIOVREF__Vin_Pot_net;

	cy_psoc3_pins_v1_10
		#(.id("074369c7-4c22-46f2-a9a1-5542c7bdab1a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Vin_Pot
		 (.oe(tmpOE__Vin_Pot_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vin_Pot_net[0:0]}),
		  .analog({Net_803}),
		  .io({tmpIO_0__Vin_Pot_net[0:0]}),
		  .siovref(tmpSIOVREF__Vin_Pot_net),
		  .interrupt({tmpINTERRUPT_0__Vin_Pot_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vin_Pot_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("41d54d57-17a5-4f4f-8473-3ab32489d000"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__mcp2515_clk_net;
	wire [0:0] tmpFB_0__mcp2515_clk_net;
	wire [0:0] tmpIO_0__mcp2515_clk_net;
	wire [0:0] tmpINTERRUPT_0__mcp2515_clk_net;
	electrical [0:0] tmpSIOVREF__mcp2515_clk_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		mcp2515_clk
		 (.oe(tmpOE__mcp2515_clk_net),
		  .y({Net_995}),
		  .fb({tmpFB_0__mcp2515_clk_net[0:0]}),
		  .io({tmpIO_0__mcp2515_clk_net[0:0]}),
		  .siovref(tmpSIOVREF__mcp2515_clk_net),
		  .interrupt({tmpINTERRUPT_0__mcp2515_clk_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__mcp2515_clk_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Counter_v3_0_3 Encoder_Count (
        ...
        .up_ndown(1'b1),
        .count(Net_911));
    defparam Encoder_Count.CaptureMode = 0;
    defparam Encoder_Count.ClockMode = 0;
    defparam Encoder_Count.CompareMode = 1;
    defparam Encoder_Count.CompareStatusEdgeSense = 1;
    defparam Encoder_Count.EnableMode = 0;
    defparam Encoder_Count.ReloadOnCapture = 0;
    defparam Encoder_Count.ReloadOnCompare = 0;
    defparam Encoder_Count.ReloadOnOverUnder = 0;
    defparam Encoder_Count.ReloadOnReset = 1;
    defparam Encoder_Count.Resolution = 16;
    defparam Encoder_Count.RunMode = 0;
    defparam Encoder_Count.UseInterrupt = 1;
    ...
    Counter_v3_0_4 Time_Count (
        ...
        .up_ndown(1'b1),
        .count(Net_1162));
    defparam Time_Count.CaptureMode = 0;
    defparam Time_Count.ClockMode = 0;
    defparam Time_Count.CompareMode = 1;
    defparam Time_Count.CompareStatusEdgeSense = 1;
    defparam Time_Count.EnableMode = 0;
    defparam Time_Count.ReloadOnCapture = 0;
    defparam Time_Count.ReloadOnCompare = 0;
    defparam Time_Count.ReloadOnOverUnder = 0;
    defparam Time_Count.ReloadOnReset = 1;
    defparam Time_Count.Resolution = 16;
    defparam Time_Count.RunMode = 0;
    defparam Time_Count.UseInterrupt = 1;
    ...
    Timer_v2_70_5 CAN_TIMER (
        .reset(Net_1133),
        .interrupt(Net_1181),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1219),
        .tc(Net_1220),
        .clock(Net_1162));
    ...
    defparam CAN_TIMER.InterruptOnTC = 1;
    defparam CAN_TIMER.Resolution = 16;
	...
	cy_psoc3_pins_v1_10
		#(.id("a72afdf7-3288-4a6c-92af-7462774a5a37"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ISR_PIN_net;
	wire [0:0] tmpFB_0__ISR_PIN_net;
	wire [0:0] tmpIO_0__ISR_PIN_net;
	wire [0:0] tmpINTERRUPT_0__ISR_PIN_net;
	electrical [0:0] tmpSIOVREF__ISR_PIN_net;

	cy_psoc3_pins_v1_10
		#(.id("93f8ab82-9aa8-4c1a-a45f-c5887359957b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ISR_PIN
		 (.oe(tmpOE__ISR_PIN_net),
		  .y({Net_1181}),
		  .fb({tmpFB_0__ISR_PIN_net[0:0]}),
		  .io({tmpIO_0__ISR_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__ISR_PIN_net),
		  .interrupt({tmpINTERRUPT_0__ISR_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ISR_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

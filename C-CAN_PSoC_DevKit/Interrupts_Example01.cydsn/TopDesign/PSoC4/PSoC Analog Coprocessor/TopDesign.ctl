...
-- === RGB LED ===
attribute port_location of LED_Nested(0) : label is "PORT(1,4)"; -- RED LED
attribute port_location of LED_Isr(0) : label is "PORT(2,6)"; -- GREEN LED
attribute port_location of REPLACE_WITH_ACTUAL_PIN_NAME(0) : label is "PORT(1,6)"; -- BLUE LED

-- === USER SWITCH ===
attribute port_location of Pin_Sw(0) : label is "PORT(0,3)";
